...
public class BinaryTest 
{
    ...
    public void testAND() {
        //Create two binary objects to define the two binary numbers
        Binary binary1 = new Binary("1000");
        Binary binary2 = new Binary("1111");

        //Calculate AND operation between the two binary numbers
    ...
    public void testOR() {
        ...
        //The expected output
        assertTrue(result.getValue().equals("1111")); // Expected result
    }
    ...
    public void testMultiply() {
        ...
        //The expected output
        assertTrue(result.getValue().equals("1111000")); // Expected result
    }
}
